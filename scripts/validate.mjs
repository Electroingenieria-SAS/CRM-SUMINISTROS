...
// Release identity.
check(version==="11.35.3","CONFIG.version debe ser 11.35.3.");
check(build==="2026-09-23.13","CONFIG.build debe ser 2026-09-23.13.");
...
check(sw.includes('// previous-cache: crm-suministros-v11-35-2-20260923-12'),"previous-cache PWA debe apuntar a V11.35.2.");
check(sw.includes('const CACHE="crm-suministros-v11-35-3-20260923-13";'),"CACHE activo PWA no corresponde a V11.35.3.");
