...
check(sw.includes('// previous-cache: crm-suministros-v11-34-2-20260923-06'),"previous-cache PWA debe apuntar a V11.34.2.");
check(sw.includes('const CACHE="crm-suministros-v11-34-3-20260923-07";'),"CACHE activo PWA no corresponde a V11.34.3.");
