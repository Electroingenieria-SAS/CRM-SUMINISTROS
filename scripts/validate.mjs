...
const inventoryModule=read("assets/js/modules/inventory.js"),inventoryService=read("assets/js/services/inventory.js");
...
check(version==="11.23.0","CONFIG.version debe ser 11.23.0.");
check(build==="2026-09-09.01","CONFIG.build debe ser 2026-09-09.01.");
...
check(sw.includes('// previous-cache: crm-suministros-v11-21-1-20260908-12'),"previous-cache PWA debe apuntar al cache productivo anterior.");
check(sw.includes('const CACHE="crm-suministros-v11-23-0-20260909-01";'),"CACHE activo PWA no corresponde a V11.23.0 build 01.");
...
check(inventoryModule.includes('views=[["review","Revisión"],["stock","Existencias"],["control","Inteligencia"]]'),"Los perfiles de control deben conservar Revisión/Existencias/Inteligencia.");
...
console.log("- CI única, Vercel solo desde main y PWA V11.23.0 coherente.");