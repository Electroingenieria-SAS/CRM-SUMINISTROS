...
// Release identity.
check(version==="11.38.1","CONFIG.version debe ser 11.38.1.");
check(build==="2026-09-24.29","CONFIG.build debe ser 2026-09-24.29.");
...
check(exists("assets/js/modules/paco-operational-v11370.js"),"Falta runtime PACO V11.38.1.");
check(exists("assets/js/modules/paco-language-v11373.js"),"Falta motor de lenguaje requerido por PACO V11.38.1.");
check(exists("scripts/paco-language-v11373-test.mjs"),"Falta corpus de entrenamiento requerido por PACO V11.38.1.");
check(exists("assets/runtime-css/paco-operational-v11370.css"),"Falta CSS PACO V11.38.1.");
check(sw.includes("./assets/js/modules/paco-operational-v11370.js")&&sw.includes("./assets/js/modules/paco-language-v11373.js")&&sw.includes("./assets/runtime-css/paco-operational-v11370.css"),"PWA debe precachear PACO V11.38.1 y su motor de lenguaje.");
...
check(
  ...
  "PACO V11.38.1 perdió snapshot, lenguaje entrenado, resiliencia, controles, monitoreo, resumen, alerta, registro guiado o voz."
);
...
check(sw.includes('// previous-cache: crm-suministros-v11-38-0-20260924-28'),"previous-cache PWA debe apuntar a V11.38.0.");
check(sw.includes('const CACHE="crm-suministros-v11-38-1-20260924-29";'),"CACHE activo PWA no corresponde a V11.38.1.");
...
console.log("- V11.38.1 muestra en Pedidos la etapa real del workflow dentro del chip Estado y reserva Cerrado para el final del flujo.");
