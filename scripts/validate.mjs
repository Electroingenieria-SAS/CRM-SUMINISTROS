...
// Release identity.
check(version==="11.38.2","CONFIG.version debe ser 11.38.2.");
check(build==="2026-09-24.30","CONFIG.build debe ser 2026-09-24.30.");
...
check(exists("assets/js/modules/paco-operational-v11370.js"),"Falta runtime PACO V11.38.2.");
check(exists("assets/js/modules/paco-language-v11373.js"),"Falta motor de lenguaje requerido por PACO V11.38.2.");
check(exists("scripts/paco-language-v11373-test.mjs"),"Falta corpus de entrenamiento requerido por PACO V11.38.2.");
check(exists("assets/runtime-css/paco-operational-v11370.css"),"Falta CSS PACO V11.38.2.");
check(sw.includes("./assets/js/modules/paco-operational-v11370.js")&&sw.includes("./assets/js/modules/paco-language-v11373.js")&&sw.includes("./assets/runtime-css/paco-operational-v11370.css"),"PWA debe precachear PACO V11.38.2 y su motor de lenguaje.");
...
check(
  ...
  "PACO V11.38.2 perdió snapshot, lenguaje entrenado, resiliencia, controles, monitoreo, resumen, alerta, registro guiado o voz."
);
...
check(sw.includes('// previous-cache: crm-suministros-v11-38-1-20260924-29'),"previous-cache PWA debe apuntar a V11.38.1.");
check(sw.includes('const CACHE="crm-suministros-v11-38-2-20260924-30";'),"CACHE activo PWA no corresponde a V11.38.2.");
...
console.log("- V11.38.2 separa Responsable de etapa y Vendedor, tomando el responsable desde la tarea/sesión real del paso actual.");
