...
// Release identity.
check(version==="11.36.6","CONFIG.version debe ser 11.36.6.");
check(build==="2026-09-24.21","CONFIG.build debe ser 2026-09-24.21.");
...
check(sw.includes('// previous-cache: crm-suministros-v11-36-5-20260924-20'),"previous-cache PWA debe apuntar a V11.36.5.");
check(sw.includes('const CACHE="crm-suministros-v11-36-6-20260924-21";'),"CACHE activo PWA no corresponde a V11.36.6.");
...
console.log("- V11.36.6 eleva Filtros sobre el Cronograma y amplía los avisos de contexto.");
