...
check(inventory.includes('overflow-wrap:anywhere')&&inventory.includes('@media(max-width:760px)')&&inventory.includes('@media(max-width:480px)'),"Inventario perdió las defensas responsive contra desbordes de texto.");
