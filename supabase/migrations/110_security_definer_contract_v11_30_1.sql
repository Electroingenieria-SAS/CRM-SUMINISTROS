...
-- Añade un health contract service-role-only; no modifica datos ni lógica de negocio.
...
select * from (values
  ...
  (
    ...
    case
      ...
      else 'No se detectan funciones autenticadas fuera del contrato de guardas/wrappers auditados.'
    end
  ),
  (
